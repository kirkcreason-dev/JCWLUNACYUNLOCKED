...
try{
 ...
 assert.equal($('result').hidden,true);assert.equal($('credits-art').getAttribute('src'),'./assets/ui/championship-credits.png?v=0.19.1');assert.equal(document.activeElement.id,'credits-defend');
