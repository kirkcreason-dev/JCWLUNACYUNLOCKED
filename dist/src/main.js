import {fighterPortrait,fighterAtlas} from './fighter-artwork.js?v=0.21.1';
import {RenderBudget} from './render-budget.js?v=0.21.1';
import {Coach} from './coach.js?v=0.21.1';
import {loadGameImage} from './image-loader.js?v=0.21.1';
import {fighterProfile} from './fighter-profile.js?v=0.21.1';
import {Championship,STAGES,championshipLabel,championshipArena} from './championship.js?v=0.21.1';
import {Match,STEP,emptyInput,isPoleMode,isLocalMode} from './engine.js?v=0.21.1';
import {Renderer} from './render.js?v=0.21.1';
import {Input} from './input.js?v=0.21.1';
import {Sound} from './audio.js?v=0.21.1';
import {ARENAS} from './arenas.js?v=0.21.1';
import {touchContext} from './touch-ui.js?v=0.21.1';
import {OnlineSession} from './online.js?v=0.21.1';
import {connectFirebase} from './firebase-online.js?v=0.21.1';
import {SnapshotBuffer} from './online-protocol.js?v=0.21.1';
import {RosterSelection} from './roster-selection.js?v=0.21.1';
import {retainMatchArtwork} from './artwork-cache.js?v=0.21.1';
import {phoneLayout,canvasSize,resizeCanvas} from './phone-layout.js?v=0.21.1';
import {FramePacer} from './frame-pacer.js?v=0.21.1';
import {loadOptionalArtwork} from './optional-artwork.js?v=0.21.1';
import {Haptics} from './haptics.js?v=0.21.1';
import {ArcadeRewards,ARCADE_REWARDS} from './arcade-rewards.js?v=0.21.1';
import {SecretFighters} from './secret-fighters.js?v=0.21.1';
import {fullscreenElement,toggleFullscreen} from './fullscreen.js?v=0.21.1';
