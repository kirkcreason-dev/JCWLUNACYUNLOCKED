export class Sound {
  ...
  play(events){for(const e of events){switch(e.type){case 'hit':this.tone(e.move==='heavy'?110:190,.13,'sawtooth',.10);break;case 'slam':this.tone(90,.35,'triangle',.3,22);break;case 'throwBreak':this.tone(410,.17,'triangle',.11,650);break;case 'ropeBreak':case 'holdBreak':case 'kickout':this.tone(500,.22,'triangle',.12,850);break;case 'block':this.tone(560,.08,'square',.055,160);break;case 'fight':this.tone(880,.45,'square',.075,880);break;case 'count':this.tone(620,.15,'triangle',.17,500);break;case 'special':this.tone(160,.6,'sawtooth',.08,1100);break;case 'roundEnd':this.tone(700,.5,'triangle',.13,280);break;case 'grapple':this.tone(120,.08,'triangle',.06,70);break;case 'swing':this.tone(260,.06,'triangle',.025,60);break;}}}
}
